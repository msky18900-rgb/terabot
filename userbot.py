...
async def handle_incoming(event):
    ...
    try:
        # Ensure connected before downloading
        ...
        downloaded_path = await asyncio.wait_for(
            client.download_media(msg, file=local_path, progress_callback=dl_progress),
        ...
        if not downloaded_path or not os.path.exists(downloaded_path):
            await edit_status(chat_id, msg_id, f"❌ Download failed — file missing after download.")
            return
